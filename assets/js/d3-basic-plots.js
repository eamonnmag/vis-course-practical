var d3_basic_plots = (function () {
    ...
    return {
        ...
        plotDotPlot5: function (placement, width, height) {
            ...
            var x = d3_functions.pad(d3.scale.linear()
                .domain(d3.extent(data, function (d) {
                    return d.x;
                }))
                .range([0, width - margin.left - margin.right]), 10);

            var y = d3_functions.pad(d3.scale.linear()
                .domain(d3.extent(data, function (d) {
                    return d.y;
                }))
